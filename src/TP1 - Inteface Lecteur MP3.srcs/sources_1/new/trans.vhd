...
--blocs compteur/décompteur représentent des nombres entiers codés sur n-bits.
--Ce bloc permet donc le transcodage de ces informations vers un format
--compatible avec un afficheur sept segments. Il permet aussi de spécifier le
